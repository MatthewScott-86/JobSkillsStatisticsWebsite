...
class PlotGenerator():
    ...
    def GetSkillsFromJobRegionDateCount(self, job, region):
    ...
    def GetSkillsFromJobRegion(self, job, region):
    ...
    def CompareJobsPlot(self, job1, job2):
    ...
    def GlassdoorPlot1(self, genstat):
    ...
    def GlassdoorPlot2(self, boxplot2):
        Jan2018 = pd.read_excel(os.path.join(settings.BASE_DIR, 'data/LPR_data-2018-01.xlsx'))
    ...
    def GlassdoorPlot6(self, boxplot):
        Jan2018 = pd.read_excel(os.path.join(settings.BASE_DIR, 'data/LPR_data-2018-01.xlsx'))
